        ...
        <table class="tbl">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="max-width:110px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;font-size:13px;">{{ $asp->inputAspirasi?->lokasi ?? '—' }}</td>
                    <td style="max-width:160px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;color:var(--muted);font-size:12px;">{{ $asp->inputAspirasi?->ket ?? '—' }}</td>
                    <td>
                        @if($asp->foto_laporan)
                        ...
                        @elseif($asp->foto_selesai)
                            <a href="{{ Storage::url($asp->foto_selesai) }}" target="_blank">
                                <img src="{{ Storage::url($asp->foto_selesai) }}" alt="foto selesai" style="width:40px;height:40px;object-fit:cover;border-radius:4px;border:1px solid #bbf7d0;">
                            </a>
                        @else
