...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Poppins:wght@700;800;900&family=Plus+Jakarta+Sans:wght@400;500;600;700&display=swap"
        rel="stylesheet" />
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-hd">
            <img src="{{ asset('images/logo.png') }}" class="sidebar-logo" id="sidebarLogoImg"
        ...
        <nav class="sidebar-nav">
            ...
            @if (auth()->user()->isAdmin())
                ...
                <a href="{{ route('admin.histori') }}"
                    class="nav-link {{ Route::is('admin.histori') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.ruangan') }}"
                    class="nav-link {{ Route::is('admin.ruangan') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.pantau') }}"
                    class="nav-link {{ Route::is('admin.pantau*') ? 'active' : '' }}">
                    <span class="msym">visibility</span> Pantau Ruangan
                </a>
                <a href="{{ route('admin.pengaturan') }}"
                    class="nav-link {{ Route::is('admin.pengaturan') ? 'active' : '' }}">
                    <span class="msym">settings</span> Pengaturan
                </a>
            @elseif(auth()->user()->isSiswa())
                <div class="nav-sect">Siswa</div>
                <a href="{{ route('siswa.dashboard') }}"
                    class="nav-link {{ Route::is('siswa.dashboard') ? 'active' : '' }}">
            ...
            @elseif(auth()->user()->isPJ())
                ...
                <a href="{{ route('pj.dashboard') }}"
                    class="nav-link {{ Route::is('pj.dashboard') ? 'active' : '' }}">
    ...
    <nav class="bottom-nav">
        <div class="bn-inner">
            @if (auth()->user()->isAdmin())
                <a href="{{ route('admin.dashboard') }}"
                    class="bn-item {{ Route::is('admin.dashboard') ? 'active' : '' }}">
                    <span class="msym">dashboard</span><span>Home</span>
                </a>
                <a href="{{ route('admin.histori') }}"
                    class="bn-item {{ Route::is('admin.histori') ? 'active' : '' }}">
                ...
                <a href="{{ route('admin.kategori') }}"
                    class="bn-item {{ Route::is('admin.kategori') ? 'active' : '' }}">
                    <span class="msym">category</span><span>Kategori</span>
                </a>
                <a href="{{ route('admin.pantau') }}"
                    class="bn-item {{ Route::is('admin.pantau*') ? 'active' : '' }}">
                    <span class="msym">visibility</span><span>Pantau</span>
                </a>
            @elseif(auth()->user()->isSiswa())
                <a href="{{ route('siswa.dashboard') }}"
                    class="bn-item {{ Route::is('siswa.dashboard') ? 'active' : '' }}">
                    <span class="msym">add_circle</span><span>Pengaduan</span>
                </a>
                <a href="{{ route('siswa.riwayat') }}"
                    class="bn-item {{ Route::is('siswa.riwayat') ? 'active' : '' }}">
                    <span class="msym">receipt_long</span><span>Riwayat</span>
                </a>
            @elseif(auth()->user()->isPJ())
                <a href="{{ route('pj.dashboard') }}"
                    class="bn-item {{ Route::is('pj.dashboard') ? 'active' : '' }}">
